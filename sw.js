const CACHE='fiche-site-eib-v4';
const ASSETS=['./','./index.html','./styles.css','./app.js?v=4','./docx-lib.js?v=4','./manifest.webmanifest','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png'];
