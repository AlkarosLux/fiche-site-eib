const CACHE='fiche-site-eib-v9';
const ASSETS=['./','./index.html','./styles.css','./fix-v5.css','./app.js?v=9','./docx-lib.js?v=4','./manifest.webmanifest?v=8','./icon.svg','./icon-180.png?v=8','./icon-192.png?v=8','./icon-512.png?v=8'];
